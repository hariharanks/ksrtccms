...
<section id="main-content"><section class="wrapper">
          ...
          <section class="panel">
                  ...
                  <table class="table table-hover p-table">
                      ...
                      <tr>
                          <td class="p-name">
                              <a href="projectdetails.php">Name</a>
                              <br>
                      ...
                      <tr>
                          ...
                          <td>
                            ...
                            <form role="form">
                                  ...
                                  <label for="exampleInputPassword1">Designation Type</label>
                                      <select class="form-control m-bot15">
                                  ...
                                  <div class="form-group">
                                     Address
                                      <textarea type="text" class="form-control" id="exampleInputPassword1" placeholder="">
                                      </textarea>
                                  </div>
                                  <div class="form-group">
                                     District
                                  ...
                                  <div class="form-group">
                                      <label for="exampleInputFile">Id Proof Copy</label>
                                      <input type="file" id="exampleInputFile">
                                      <p class="help-block">Size 350 px x 450 px</p>
                                  </div>
                                  <div class="form-group">
